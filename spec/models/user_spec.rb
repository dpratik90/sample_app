...
describe User do
  before {@user = User.new(name: 'test', email:'test@hello.com',
  						   password: "foobar",
  ...
  describe "when length of the name is too long" do
  ...
  describe "when email address is invalid" do
    ...
    describe "return value of authenticate method" do
    	...
    	describe "when password matches" do
    ...
    describe "when password length is less than 6 chars" do
